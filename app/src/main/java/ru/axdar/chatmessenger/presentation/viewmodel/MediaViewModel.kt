...
import ru.axdar.chatmessenger.domain.media.CreateImageFile
import ru.axdar.chatmessenger.domain.media.EncodeImageBitmap
import ru.axdar.chatmessenger.domain.media.GetPickedImage
...
class MediaViewModel @Inject constructor(
    ...
    fun createImageFile() {
        createImageFileUseCase.invoke(None()) { it.either(::handleFailure, ::handleCameraFileCreated) }
    }
